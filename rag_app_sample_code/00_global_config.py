...
RAG_APP_NAME = 'felix_cb_oct'

# UC Catalog & Schema where outputs tables/indexs are saved
# If this catalog/schema does not exist, you need create catalog/schema permissions.
UC_CATALOG = f'{user_name}' # f'{user_name}_catalog'
UC_SCHEMA = 'cookbook_felix_october'
...
SOURCE_PATH = "/Volumes/felixflory/rag_felixflory/source_docs" # f"/Volumes/{UC_CATALOG}/{UC_SCHEMA}/source_docs"
