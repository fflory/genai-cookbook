...
# MAGIC %pip install pymupdf transformers torch
...
filepath = "./ey_dbs_one_page_pdf.pdf"
images = rasterize_paper(pdf=filepath, return_pil=True)
#image = Image.open(images[0])
#image = Image.open("./ey_dbs_one_page_pdf.jpg")
image = Image.open("./cropped_table.jpeg")
image
